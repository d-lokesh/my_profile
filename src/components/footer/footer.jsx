            ...
            <div className="container-fluid">
                <div className="row" style={{ backgroundColor: "black", textAlign: "left", color: "gray", fontSize: "14px" }}>                <div className="col-md-1"></div>
                    ...
                    <div className="col-md-2    "> <br />
                        <h5 style={{ textAlign: "left", color: "white" }}> Services</h5>
                        <br />
                        <p> <span><ArrowRightAltSharpIcon />Web Design </span></p>
                        <p> <span><ArrowRightAltSharpIcon />Web Development </span></p>
                        <p><span><ArrowRightAltSharpIcon />Business Strategy</span></p>
                        <p> <span><ArrowRightAltSharpIcon />Data Analysis </span></p></div>
                    <div className="col-md-1"> </div>
                    <div className="col-md-2">
                        <br />
                        ...
                        <br />
                        <p><span><LocationOnSharpIcon></LocationOnSharpIcon>7-30 kvreddy nagar colony,kompally,hyderabad,Telangana</span></p>
